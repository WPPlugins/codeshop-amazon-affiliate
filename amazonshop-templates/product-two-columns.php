<?php
/**
 * This template display two columns view of products
 ...
 * which path should be as wp-content/themes/{your-active-theme}/amazonshop-templates/product-two-columns.php
                ...
                for ( $p = 0; $p < 2; $p++ ) {
                    ...
                    <li>
                        <a href="<?php echo $amazon_products[$i]['DetailPageURL'];?>" target="_new">
                            ...
                            <div class="caaps-amazonbuy-btn-wrapper">
