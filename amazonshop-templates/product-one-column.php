                ...
                <?php 
                    ...
                    <li>
                        <a href="<?php echo $amazon_products[$i]['DetailPageURL'];?>" target="_new">
						   ...
						   <?php
                            echo ( isset( $amazon_products[$i]['LargeImage'] ) && ( ! empty( $amazon_products[$i]['LargeImage'] )) )? '<img class="large-image" src="'.$amazon_products[$i]['LargeImage'].'" alt="'.$amazon_products[$i]['Title'].'" />' : '';
							?>
                            </div>
