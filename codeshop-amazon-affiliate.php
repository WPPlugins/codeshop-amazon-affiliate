 ...
 * Description: CodeShop Amazon Affiliate plugin will help you to create a complete amazon store, add thousands product by                creating different categories and add products accordingly. Also support adding products with Wordpress regular                posts and pages. Make ready your site as you want with easy customizable templates to advertise amazon products to                sell and earn commissions. 
 * Version:     1.1.2
 * Author:      CodeApple
 ...
 */
  ...
  define( 'AMZONPRODUCTSHOP_VERSION', '1.1.2' );
